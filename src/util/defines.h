...
// TODO Test lua test with OpenGL later
#define LUA_TEST
#endif
...
private:
	...
	static constexpr const wchar_t* TITLE = L"KCNet ImGui DirectX Test";

	// TODO Add more of these
	static constexpr const wchar_t* MAIN_MENU_TITLE_ = L"Main Menu";
	static constexpr const char* IMGUI_WINDOW_NAME_ = "KCNet ImGui";
